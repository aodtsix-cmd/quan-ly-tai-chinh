...
App.LABEL_MAPS = {
  ...
  plan_section: {
    vi: { budget: "Ngân sách", goals: "Mục tiêu", events: "Sự kiện", income: "Thu nhập", recurring: "Định kỳ", forecast: "Dự báo", simulate: "Mô phỏng", analytics: "Phân tích" },
    en: { budget: "Budget", goals: "Goals", events: "Events", income: "Income", recurring: "Recurring", forecast: "Forecast", simulate: "Simulate", analytics: "Analytics" },
  },
  trend: {
...
App.I18N = {
  vi: {
    ...
    "notify.filter_all": "Tất cả",
    "notify.filter_alert": "Cảnh báo",
    "notify.filter_sub": "Đăng ký",
    "notify.filter_jar": "Hũ",
    "notify.filter_goal": "Mục tiêu",
    "notify.empty_title": "Không có nhắc nào ở đây",
    "notify.empty_subtitle": "Im lặng nghĩa là không có gì sắp đến hạn.",
    "notify.tag_alert": "Cảnh báo",
    "notify.tag_jar": "Hũ ngân sách",
    "notify.tag_goal": "Mục tiêu",
    "notify.alert_title_danger": "Cảnh báo khẩn cấp",
    "notify.alert_title_warning": "Cảnh báo",
    "notify.sub_due_today": "Thu {{amount}}đ hôm nay",
    "notify.sub_due_in": "Thu {{amount}}đ sau {{n}} ngày",
    "notify.jar_over": "Hũ {{category}} đã vượt hạn mức {{amount}}đ",
    "notify.jar_near": "Hũ {{category}} còn {{amount}}đ, đã dùng {{pct}}%",
    "notify.goal_overdue": "Mục tiêu {{name}} đã quá hạn, còn thiếu {{amount}}đ",
    "notify.goal_off_track": "Mục tiêu {{name}} đang chậm tiến độ, cần thêm {{amount}}đ/kỳ",
    ...
    "plan.hub.intro": "Tám khu vực, từ phân tích chi tiêu tới dự báo nhiều kỳ tới. Chọn một khu để bắt đầu.",

    "plan.analytics.title": "Phân tích chi tiêu",
    "plan.analytics.desc": "Tổng thu chi kỳ này, biến động 6 kỳ gần nhất, và chi theo danh mục.",
    "plan.analytics.total_out": "TỔNG CHI KỲ NÀY",
    "plan.analytics.saved": "DÀNH ĐƯỢC",
    "plan.analytics.chart_title": "Vào / ra 6 kỳ gần nhất",
    "plan.analytics.category_title": "Chi theo danh mục",
    "plan.analytics.no_history": "Chưa đủ dữ liệu — cần thêm giao dịch qua vài kỳ nữa.",
    ...
    "plan.budget.current_tag": "kỳ này",
    "plan.budget.remaining": "CÒN LẠI TRONG KỲ",
    "plan.budget.per_day_left": "mỗi ngày còn lại",
    "plan.budget.time_elapsed": "Thời gian đã trôi",
    "plan.budget.spent_so_far": "Đã tiêu ngân sách",
    "plan.budget.pace_under": "Chậm hơn nhịp {{n}}%",
    "plan.budget.pace_over": "Nhanh hơn nhịp {{n}}%",
    "plan.budget.pace_under_detail": "khoảng cách này là tiền bạn đang giữ lại được.",
    "plan.budget.pace_over_detail": "tiêu nhanh hơn thời gian trôi, kỳ này dễ vượt hũ.",
    "plan.budget.jar_left": "còn {{amount}}",
    "plan.budget.jar_over": "vượt {{amount}}",
    "plan.budget.jar_note_ok": "trong nhịp",
    "plan.budget.jar_note_near": "sát hạn mức",
    "plan.budget.jar_note_over": "vượt hũ",
    "plan.budget.manual_amount_label": "Sửa tay hạn mức",
    "plan.budget.jars_footnote": "Hũ chỉ giới hạn chi — tiền vào và chuyển nội bộ không trừ hũ nào. Vượt hũ không chặn bạn ghi giao dịch, chỉ đổi màu và tính lại nhịp.",
    ...
    "plan.goals.hub_subtitle": "{{n}} mục tiêu đang chạy",
    "plan.goals.total_saved": "TỔNG ĐÃ TÍCH LŨY",
    "plan.goals.total_saved_pct": "Đạt {{pct}}% tổng mục tiêu",
    "plan.goals.periods_left": "còn {{n}} kỳ",
    "plan.goals.per_period_short": "{{amount}}đ/kỳ",
    "plan.goals.topup_button": "Nạp thêm",
    "plan.goals.detail_button": "Chi tiết",
    "plan.goals.donut_label": "ĐÃ GÓP",
    "plan.goals.remaining_label": "Còn thiếu {{amount}}đ",
    "plan.goals.per_period_label": "GÓP MỖI KỲ",
    "plan.goals.eta_label": "DỰ KIẾN ĐỦ",
    "plan.goals.eta_done": "Đã đủ",
    "plan.goals.eta_periods": "sau {{n}} kỳ",
    "plan.goals.topup_title": "Nạp thêm vào hũ",
    "plan.goals.quick_rest": "Cho đủ",
    "plan.goals.topup_source_label": "Lấy tiền từ",
    "plan.goals.topup_transfer_note": "Ghi thành <b>chuyển nội bộ</b> — không tính là chi, không trừ hũ ngân sách nào.",
    "plan.goals.topup_submit": "Nạp vào hũ",
    "plan.goals.topup_description": "Nạp {{name}}",
    "plan.goals.topup_saved": "Đã nạp thành công.",
    "plan.goals.recent_title": "Chuyển vào tài khoản này gần đây",
    "plan.goals.recent_none": "Chưa có khoản chuyển nào vào tài khoản này.",
    "plan.goals.settings_title": "Thiết lập hũ",
    "plan.goals.settings_account": "Tài khoản liên kết",
    "plan.goals.hide_note": "Ẩn giữ nguyên lịch sử góp · không có nút xóa vĩnh viễn.",
    ...
    "plan.income.actual_title": "Ước tính so với thực tế",
    "plan.income.actual_intro": "So sánh tổng ước tính từ các nguồn thu với số bạn đã thực sự ghi nhận là khoản thu (không tính chuyển khoản nội bộ) trong kỳ này, theo đúng nhịp thời gian đã trôi qua.",
    "plan.income.actual_income": "Đã thu thực tế",
    "plan.income.expected_total": "Ước tính cả kỳ",
    "plan.income.expected_to_date": "Dự kiến tới hôm nay",
    "plan.income.pace_ahead": "Vượt tiến độ",
    "plan.income.pace_on_track": "Đúng tiến độ",
    "plan.income.pace_behind": "Hơi chậm so với dự kiến",
    "plan.income.pace_far_behind": "Chậm nhiều so với dự kiến",
    "plan.income.no_estimate_note": "Chưa khai báo nguồn thu nào nên chưa có gì để so sánh — thêm ở bên dưới.",
    ...
    "plan.forecast.lowest_point": "số dư thấp nhất trong 6 kỳ",
  ...
  en: {
    ...
    "notify.filter_all": "All",
    "notify.filter_alert": "Alerts",
    "notify.filter_sub": "Subscriptions",
    "notify.filter_jar": "Jars",
    "notify.filter_goal": "Goals",
    "notify.empty_title": "Nothing here",
    "notify.empty_subtitle": "Quiet means nothing is due soon.",
    "notify.tag_alert": "Alert",
    "notify.tag_jar": "Budget jar",
    "notify.tag_goal": "Goal",
    "notify.alert_title_danger": "Urgent alert",
    "notify.alert_title_warning": "Alert",
    "notify.sub_due_today": "{{amount}}đ due today",
    "notify.sub_due_in": "{{amount}}đ due in {{n}} days",
    "notify.jar_over": "{{category}} jar is {{amount}}đ over its limit",
    "notify.jar_near": "{{category}} jar has {{amount}}đ left, {{pct}}% used",
    "notify.goal_overdue": "{{name}} is overdue, {{amount}}đ short",
    "notify.goal_off_track": "{{name}} is off track, needs {{amount}}đ more per period",
    ...
    "plan.hub.title": "Plan",
    "plan.hub.intro": "Eight areas, from spending analytics to a forecast several periods out. Pick one to start.",

    "plan.analytics.title": "Spending analytics",
    "plan.analytics.desc": "This period's income/expense total, the last 6 periods' swing, and spend by category.",
    "plan.analytics.total_out": "TOTAL SPEND THIS PERIOD",
    "plan.analytics.saved": "SAVED",
    "plan.analytics.chart_title": "In / out, last 6 periods",
    "plan.analytics.category_title": "Spend by category",
    "plan.analytics.no_history": "Not enough data yet — needs a few more periods of transactions.",
    ...
    "plan.budget.current_tag": "this period",
    "plan.budget.remaining": "LEFT THIS PERIOD",
    "plan.budget.per_day_left": "per remaining day",
    "plan.budget.time_elapsed": "Time elapsed",
    "plan.budget.spent_so_far": "Budget spent",
    "plan.budget.pace_under": "{{n}}% behind pace",
    "plan.budget.pace_over": "{{n}}% ahead of pace",
    "plan.budget.pace_under_detail": "that gap is money you're holding onto.",
    "plan.budget.pace_over_detail": "spending faster than time is passing — easy to go over this period.",
    "plan.budget.jar_left": "{{amount}} left",
    "plan.budget.jar_over": "{{amount}} over",
    "plan.budget.jar_note_ok": "on pace",
    "plan.budget.jar_note_near": "near the limit",
    "plan.budget.jar_note_over": "over the jar",
    "plan.budget.manual_amount_label": "Edit the limit by hand",
    "plan.budget.jars_footnote": "Jars only cap expenses — income and internal transfers never touch a jar. Going over never blocks recording a transaction, it just changes color and recalculates pace.",
    ...
    "plan.goals.hub_subtitle": "{{n}} goals in progress",
    "plan.goals.total_saved": "TOTAL SAVED",
    "plan.goals.total_saved_pct": "{{pct}}% of total goal",
    "plan.goals.periods_left": "{{n}} periods left",
    "plan.goals.per_period_short": "{{amount}}đ/period",
    "plan.goals.topup_button": "Top up",
    "plan.goals.detail_button": "Details",
    "plan.goals.donut_label": "SAVED",
    "plan.goals.remaining_label": "{{amount}}đ short",
    "plan.goals.per_period_label": "PER PERIOD",
    "plan.goals.eta_label": "ETA",
    "plan.goals.eta_done": "Fully funded",
    "plan.goals.eta_periods": "in {{n}} periods",
    "plan.goals.topup_title": "Top up this vault",
    "plan.goals.quick_rest": "Fill it",
    "plan.goals.topup_source_label": "Take money from",
    "plan.goals.topup_transfer_note": "Recorded as an <b>internal transfer</b> — not counted as an expense, doesn't touch any budget jar.",
    "plan.goals.topup_submit": "Add to vault",
    "plan.goals.topup_description": "Top-up: {{name}}",
    "plan.goals.topup_saved": "Added successfully.",
    "plan.goals.recent_title": "Recent transfers into this account",
    "plan.goals.recent_none": "No transfers into this account yet.",
    "plan.goals.settings_title": "Vault settings",
    "plan.goals.settings_account": "Linked account",
    "plan.goals.hide_note": "Hiding keeps the contribution history — there's no permanent delete.",
    ...
    "plan.income.actual_title": "Estimated vs actual",
    "plan.income.actual_intro": "Compares your income sources' total estimate against what you've actually recorded as income (internal transfers excluded) this period, paced against how much of the period has elapsed.",
    "plan.income.actual_income": "Actual income so far",
    "plan.income.expected_total": "Estimated for the period",
    "plan.income.expected_to_date": "Expected by today",
    "plan.income.pace_ahead": "Ahead of schedule",
    "plan.income.pace_on_track": "On track",
    "plan.income.pace_behind": "A bit behind schedule",
    "plan.income.pace_far_behind": "Well behind schedule",
    "plan.income.no_estimate_note": "No income sources declared yet, so there's nothing to compare against - add one below.",
    ...
    "plan.forecast.lowest_point": "lowest balance over 6 periods",
